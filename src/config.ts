...
export const MODE_WEBSITE = (
    IS_WEBSITE || window.location.search.includes('mode=website'))
export const MODE_EMBED = (
    !MODE_WEBSITE || window.location.search.includes('mode=embed'))
